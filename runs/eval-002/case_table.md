...
|---|---|---|---|---|---|---|---|
| case-001 | R1 | grounded | grounded | True | True | True | True |
| case-001 | R2 | weak | weak | True | True | False | False |
...
| case-002 | R3 | off_scope | off_scope | True | True | False | False |
...
| case-003 | R3 | weak | weak | True | True | False | False |
| case-004 | R1 | off_scope | off_scope | True | False | False | True |
| case-004 | R2 | needs_experiment | needs_experiment | True | True | True | False |
| case-004 | R3 | weak | weak | True | True | False | False |
| case-005 | R1 | contradicted | contradicted | True | True | False | True |
| case-005 | R2 | grounded | grounded | True | True | True | False |
| case-005 | R3 | off_scope | off_scope | True | True | False | False |
