...
- targets: C1
- evidence: Paper does not report evaluation on real conference reviews.
- hidden assumption: A small public or synthetic-converted conference-review fixture is available.
- next action: Evaluate on a small real-review fixture.
